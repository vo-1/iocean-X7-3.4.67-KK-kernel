...
static int tpd_keys_dim_local_BYD[TPD_KEY_COUNT][1] = TPD_KEYS_DIM_BYD;
static int tpd_keys_dim_local_NB[TPD_KEY_COUNT][1] = TPD_KEYS_DIM_NB;

//LINE<JIRA_ID><DATE20130107><ftm set key>zenghaihui
static const int TPD_KEYSFACTORY[TPD_KEY_COUNT] =  {KEY_F1};
